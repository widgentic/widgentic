...
`CHROME_DEFAULTS` is not a description of the defaults — it *is* them; the injected stylesheet is generated from it. Paint your own surfaces from the same object and the two can never drift:

...
#### Scenario: Use as base seeds a new widget
- **WHEN** `Use as base` is clicked on a stored `person-card` row
...
#### Scenario: Use as base seeds a new theme
- **WHEN** `Use as base` is clicked on a stored theme row
